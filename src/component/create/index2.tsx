...
function Index({}: Props) {
  ...
  console.log("url", url);
  return (
    // What is this doing? Slight differences depending on close and url...?
    <div
      className={
        close
          ? "h-full bg-[#0D0D0D99] backdrop-blur-[10px] relative"
          : url
    ...
    >
      ...
      {/* Separate screens for each page */}
      <div
        className={
      ...
      >
        ...
        {/* Should be making the webcam full screen... and then everything else is absolute on top of it */}
        <Webcam
          audio={false}
          width={"100%"}
          height={"100%"}
      ...
      {upload && (
        // Animation to replace full screen
        <Bodyanimation> 
          <Template
            url={url}
            list={list}
